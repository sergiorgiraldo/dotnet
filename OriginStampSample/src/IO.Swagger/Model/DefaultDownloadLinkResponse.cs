...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DefaultDownloadLinkResponse :  IEquatable<DefaultDownloadLinkResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultDownloadLinkResponse" /> class.
        /// </summary>
        ...
        public DefaultDownloadLinkResponse(DownloadLinkResponse data = default(DownloadLinkResponse), int? errorCode = default(int?), string errorMessage = default(string))
        {
            this.Data = data;
        ...
        public DownloadLinkResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DefaultDownloadLinkResponse {\n");
        ...
        {
            return this.Equals(input as DefaultDownloadLinkResponse);
        }

        /// <summary>
        /// Returns true if DefaultDownloadLinkResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DefaultDownloadLinkResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefaultDownloadLinkResponse input)
        {
            if (input == null)
                return false;
