...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DefaultWebhookResponse :  IEquatable<DefaultWebhookResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultWebhookResponse" /> class.
        /// </summary>
        ...
        public DefaultWebhookResponse(WebhookResponse data = default(WebhookResponse), int? errorCode = default(int?), string errorMessage = default(string))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DefaultWebhookResponse {\n");
        ...
        {
            return this.Equals(input as DefaultWebhookResponse);
        }

        /// <summary>
        /// Returns true if DefaultWebhookResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DefaultWebhookResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefaultWebhookResponse input)
        {
            if (input == null)
                return false;
