...
namespace IO.Swagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.originstamp.org");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.originstamp.org).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.originstamp.org")
        {
