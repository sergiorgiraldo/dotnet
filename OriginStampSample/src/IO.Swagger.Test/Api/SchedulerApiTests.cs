...
namespace IO.Swagger.Test
{
    ...
    public class SchedulerApiTests
    {
        ...
        public void GetActiveCurrenciesTest()
        {
            ...
            //var response = instance.GetActiveCurrencies();
            //Assert.IsInstanceOf<DefaultListCurrencyModel> (response, "response is DefaultListCurrencyModel");
        }
        
        /// <summary>
        /// Test GetNextSchedulingTime
        /// </summary>
        [Test]
        public void GetNextSchedulingTimeTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string authorization = null;
            //SchedulerRequest schedulerRequest = null;
            //var response = instance.GetNextSchedulingTime(authorization, schedulerRequest);
            //Assert.IsInstanceOf<DefaultSchedulerResponse> (response, "response is DefaultSchedulerResponse");
        }
